...
module {
  ...
  public func userInfoJson(userInfo: UserInfo) : Text {
    ...
    "{ \"userID\": \"" # Nat16.toText(userInfo.userID) # "\", \"vaultToken\": \"" # userInfo.vaultToken # "\", \"principal\": \"" # principalText # "\", \"redemptions\": \"" # redemptions # "\", \"portfolio\": \"" # portfolio # "\", \"transactions\": \"" # transactions # "\" }";
  };
